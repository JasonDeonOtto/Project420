...
namespace Project420.Management.Models.Entities.Sales.Wholesale

{
    ...
    /// </remarks>
    public class WholesalePricelist : AuditableEntity
    {
        // ============================================================
        // BASIC INFORMATION
        // ============================================================
        ...
        /// </remarks>
        public virtual ICollection<WholesalePricelistItem> WholesalePricelistItems { get; set; } = new List<WholesalePricelistItem>();
    ...
    /// </remarks>
    public class WholesalePricelistItem : AuditableEntity
    {
        /// <summary>
        ...
        public int WholesalePricelistId { get; set; }
        ...
        /// </summary>
        [ForeignKey(nameof(WholesalePricelistId))]
        public virtual WholesalePricelist WholesalePricelist { get; set; } = null!;
