...
namespace Project420.Management.Models.Entities.Sales.Retail
{
    /// <summary>
    ...
    /// </remarks>
    public class RetailPricelist : AuditableEntity
    {
        // ============================================================
        // BASIC INFORMATION
        // ============================================================
        ...
        /// </remarks>
        public virtual ICollection<RetailPricelistItem> PricelistItems { get; set; } = new List<RetailPricelistItem>();
    ...
    /// </remarks>
    public class RetailPricelistItem : AuditableEntity
    {
        /// <summary>
        ...
        public int RetailPricelistId { get; set; }
        ...
        /// </summary>
        [ForeignKey(nameof(RetailPricelistId))]
        public virtual RetailPricelist RetailPricelist { get; set; } = null!;
