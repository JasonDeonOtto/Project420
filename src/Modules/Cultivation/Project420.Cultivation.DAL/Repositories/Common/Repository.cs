...
namespace Project420.Cultivation.DAL.Repositories.Common;
...
{
    protected readonly CultivationDbContext _context;
    protected readonly DbSet<T> _dbSet;

    public Repository(CultivationDbContext context)
    {
        _context = context;
